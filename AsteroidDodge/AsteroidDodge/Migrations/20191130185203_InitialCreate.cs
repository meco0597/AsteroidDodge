    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackgroundSkins", x => x.BackgroundSkinId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipSkins", x => x.ShipSkinId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnedBackgrounds", x => x.OwnedBackgroundId);
                    table.ForeignKey(
                        name: "FK_OwnedBackgrounds_AspNetUsers_AsteroidUserId",
                        column: x => x.AsteroidUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OwnedBackgrounds_BackgroundSkins_BackgroundSkinId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnedShips", x => x.OwnedShipId);
                    table.ForeignKey(
                        name: "FK_OwnedShips_AspNetUsers_AsteroidUserId",
                        column: x => x.AsteroidUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OwnedShips_ShipSkins_ShipSkinId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OwnedBackgrounds_AsteroidUserId",
                table: "OwnedBackgrounds",
                column: "AsteroidUserId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnedBackgrounds_BackgroundSkinId",
                table: "OwnedBackgrounds",
                column: "BackgroundSkinId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnedShips_AsteroidUserId",
                table: "OwnedShips",
                column: "AsteroidUserId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnedShips_ShipSkinId",
                table: "OwnedShips",
                column: "ShipSkinId");
        }
